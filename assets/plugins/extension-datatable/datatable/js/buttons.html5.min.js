...
(function (n) {
  ...
  D.ext.buttons.copyHtml5 = {
    ...
    text: function (a) {
      return a.i18n('buttons.copy', '<i title="نسخ" class="las la-clipboard fs-6"></i>');
    },
  ...
  D.ext.buttons.csvHtml5 = {
    bom: !1,
    className: 'buttons-csv buttons-html5 btn-warning',
    available: function () {
      return u.FileReader !== B && u.Blob;
    },
    text: function (a) {
      return a.i18n('buttons.csv', '<i title="تصدير ملف CSV" class="las la-file-csv fs-6"></i>');
    },
    action: function (a, c, d, b) {
      this.processing(!0);
      a = S(c, b).str;
  ...
  D.ext.buttons.excelHtml5 = {
    ...
    text: function (a) {
      return a.i18n('buttons.excel', '<i title="تصدير ملف اكسل" class="las la-file-excel fs-6"></i>');
    },
    action: function (a, c, d, b) {
      this.processing(!0);
      var m = this,
  ...
  D.ext.buttons.pdfHtml5 = {
    ...
    text: function (a) {
      return a.i18n('buttons.pdf', '<i title="تصدير ملف bdf" class="las la-file-pdf fs-6"></i>');
    },
    action: function (a, c, d, b) {
      this.processing(!0);
